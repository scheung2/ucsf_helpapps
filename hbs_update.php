    ...
    <div class="row row--demo">
        ...
        <form action="" method="post" name="form1" onSubmit="MM_validateForm('adminName', '', 'R', 'adminPhone', '', 'R', 'adminEmail', '', 'RisEmail', 'employeeName', '', 'R', 'employeeID', '', 'R', 'employeeManagementGroup', '', 'R');
            ...
            <div class="row row--demo">
                ...
                <div class="columns four four--phone">Phone #<input class="text-input" type="text" name="adminPhone"></div>
                <div class="columns four four--phone">Email Address<input class="text-input" type="text" name="adminEmail"></div> 
            </div>  
            ...
            <div columns one one--phone><input class="btn btn--primary btn--fix" type="submit" name="Submit" value="Submit Form"> </div>
